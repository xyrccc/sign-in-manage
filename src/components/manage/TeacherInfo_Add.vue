<template>
  <div class="table_box">
    ...
    <div class="title">
      <el-button type="text" class="title" size="mini" @click="goBack">教师信息管理>新增教师</el-button>
    </div>
<!--    <div class="title">-->
<!--      教师信息管理>新增教师-->
<!--    </div>-->
    ...
    <el-card>
      <el-form>
        <el-form-item>
          ...
          <el-col :span="4">
            <el-input v-model="id" placeholder="请输入工号"></el-input>
          </el-col>
          <el-col :span="4">
        ...
        <el-form-item>
          <div class="title3">
            ...
            <br>
            <img class="studentAdd" src="../../../static/images/teacherAdd.png" ></img>
          </div>
        </el-form-item>
        <el-form-item>
          <el-col :span="8">
